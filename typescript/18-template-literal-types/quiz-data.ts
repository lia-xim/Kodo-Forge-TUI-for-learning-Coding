...
export const questions: QuizQuestion[] = [
  { question: "Was erzeugt `type T = \\`${A}${B}\\`` wenn A und B Unions sind?", options: ["A | B", "A & B", "Das kartesische Produkt aller Kombinationen von A und B", "Einen Fehler"], correct: 2, explanation: "Template Literal Types bilden das kartesische Produkt. 2 Werte in A x 3 in B = 6 Kombinationen." },
  ...
  { question: "Was macht Uppercase<'hello'>?", options: ["'Hello'", "'hello'", "'hELLO'", "'HELLO' (alles gross)"], correct: 3, explanation: "Uppercase konvertiert ALLE Buchstaben zu Grossbuchstaben." },
  { question: "Was extrahiert `T extends \\`${infer P}_${string}\\` ? P : never` aus 'user_name'?", options: ["'user'", "'user_name'", "'name'", "never"], correct: 0, explanation: "infer P matcht alles VOR dem ersten Unterstrich. P = 'user'." },
  { question: "Was macht Split<'a.b.c', '.'> (rekursiver Typ)?", options: ["'a.b.c'", "'a' | 'b' | 'c'", "['a', 'b', 'c']", "['a.b.c']"], correct: 2, explanation: "Split parst den String rekursiv am Trennzeichen und erzeugt ein Tuple." },
  ...
  { question: "Wie extrahiert man Route-Parameter aus '/users/:id/posts/:postId'?", options: ["Regex", "Runtime-Parsing", "Nicht moeglich", "Rekursives Pattern Matching mit infer: :${infer Param}"], correct: 3, explanation: "Template Literal Types mit infer koennen ':param'-Patterns rekursiv extrahieren." },
  { question: "Was erzeugt EventMap<T> mit Key Remapping \\`${K}Changed\\`?", options: ["Generiert Change-Events fuer jede Property mit previousValue/newValue", "Kopiert T", "Entfernt Properties", "Macht alles optional"], correct: 0, explanation: "Template Literal im Key Remapping generiert neue Event-Namen: nameChanged, ageChanged, etc." },
  ...
  { question: "Koennen Template Literal Types zur Laufzeit verwendet werden?", options: ["Ja", "Nur in Node.js", "Nein — sie existieren nur zur Compile-Zeit", "Nur mit as const"], correct: 2, explanation: "Wie alle TypeScript-Typen werden Template Literal Types beim Compilieren entfernt." },
  { question: "Was macht ReplaceAll<'a.b.c', '.', '/'> (rekursiv)?", options: ["'a.b/c'", "'a.b.c'", "Fehler", "'a/b/c' (alle Punkte ersetzt)"], correct: 3, explanation: "ReplaceAll ersetzt rekursiv ALLE Vorkommen. Replace (ohne All) nur das erste." },
  ...
  { question: "Was ist `type SemVer = \\`${number}.${number}.${number}\\``?", options: ["Ein String-Typ fuer semantische Versionierung: '1.2.3'", "Ein Array", "Ein number", "Ein Objekt"], correct: 0, explanation: "Template Literal mit number erzeugt String-Patterns wie '1.0.0', '2.3.1', etc." },
  { question: "Welches Framework-Pattern nutzt Template Literal Types am haeufigsten?", options: ["Array-Methoden", "For-Schleifen", "Event-Handler-Namen: on${Capitalize<EventName>}", "Import-Pfade"], correct: 2, explanation: "React, Vue und andere Frameworks nutzen on${Capitalize<>} fuer Event-Props: onClick, onMouseMove, etc." },
