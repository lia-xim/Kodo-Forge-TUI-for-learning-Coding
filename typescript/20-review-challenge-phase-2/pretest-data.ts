...
export const pretestQuestions: PretestQuestion[] = [
  ...
  { sectionIndex: 2, question: "Kannst du Key Remapping mit Template Literals nutzen?", options: ["Nein", "Teilweise", "Ja", "Ich weiss es nicht"], correct: 2, briefExplanation: "as `get${Capitalize<K>}` im Mapped Type fuer Key-Transformation." },
  { sectionIndex: 2, question: "Kannst du Declaration Files schreiben?", options: ["Nein", "Teilweise", "Ja", "Ich weiss es nicht"], correct: 2, briefExplanation: "declare module, declare const, .d.ts fuer externe Typen." },
  ...
  { sectionIndex: 3, question: "Wozu braucht man Decorators?", options: ["Styling", "Ich weiss es nicht", "Type Guards", "Metaprogrammierung: Klassen/Methoden zur Laufzeit erweitern"], correct: 3, briefExplanation: "Decorators modifizieren Klassen, Methoden und Properties — z.B. fuer Logging, Validation, DI." },
  { sectionIndex: 3, question: "Welche Frameworks werden in Phase 3 behandelt?", options: ["jQuery", "Ich weiss es nicht", "Vue, Svelte", "Angular, React, Next.js"], correct: 3, briefExplanation: "Angular (Arbeit), React/Next.js (privat) — passend zu deinem Profil." },
  { sectionIndex: 2, question: "Kannst du Extract und Exclude erklaeren?", options: ["Nein", "Teilweise", "Ja", "Ich weiss es nicht"], correct: 2, briefExplanation: "Extract behaelt, Exclude entfernt Union-Member. Beide sind distributiv." },
  { sectionIndex: 2, question: "Kannst du Rekursive Types schreiben?", options: ["Nein", "Teilweise", "Ja", "Ich weiss es nicht"], correct: 2, briefExplanation: "Flatten<T>, DeepAwaited<T>, DeepReadonly<T> — Typ referenziert sich selbst." },
  { sectionIndex: 2, question: "Verstehst du den Unterschied zwischen import und import type?", options: ["Ich weiss es nicht", "Teilweise", "Nein", "Ja"], correct: 3, briefExplanation: "import type wird beim Compilieren entfernt. import bleibt im JS." },
];
